...
export const machineEvents = ["Acquisition", "Computation", "Inference", "Update", "Acquisition", "Computation", "Inference", "Update"] as const;
export const humanEvents = ["Perceive", "Integrate", "Decide", "Act"] as const;
